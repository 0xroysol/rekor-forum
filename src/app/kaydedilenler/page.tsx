...
export default async function KaydedilenlerPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-5">
      ...
      <nav className="flex items-center gap-1.5 text-sm text-[#64748b] mb-5">
        ...
        <span className="text-[#94a3b8]">Kaydedilenler</span>
      </nav>
      ...
      <div className="border border-[#1e293b] bg-[#131820] p-4 mb-4 flex items-center gap-3" style={{ borderRadius: "12px" }}>
        ...
        <div>
          <h1 className="text-lg font-semibold text-[#e2e8f0]">Kaydedilenler</h1>
          <p className="text-[#94a3b8] text-sm mt-0.5">
            {threads.length} kaydedilen konu
          </p>
        </div>
      </div>
