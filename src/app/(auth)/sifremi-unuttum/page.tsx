      ...
      <div className="w-full max-w-sm rounded-xl border border-[#1e293b] bg-[#131820] p-6">
        ...
        {sent ? (
          <div className="space-y-4">
            <div className="rounded-md border border-accent-green/30 bg-accent-green/10 px-3 py-3 text-sm text-accent-green">
              E-posta adresinize şifre sıfırlama linki gönderildi. Lütfen gelen kutunuzu kontrol edin.
            </div>
            <Link
              href="/giris"
              className="block w-full rounded-md bg-accent-green px-4 py-2 text-center text-sm font-medium text-white transition-colors hover:bg-accent-green/80"
            >
              Giriş sayfasına dön
            </Link>
          </div>
